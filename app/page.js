...
const tools = [
  { title: "Text to Image", badge: "Free", color: "from-blue-900 to-purple-900", icon: Image, link: "/create" },
  { title: "Voice Clone", badge: "Pro", color: "from-red-900 to-orange-900", icon: Mic2, link: "/create" },
  { title: "Script Writer", badge: "Free", color: "from-green-900 to-teal-900", icon: FileText, link: "/create" },
  { title: "Subtitle Generator", badge: "Free", color: "from-yellow-900 to-red-900", icon: Captions, link: "/create" },
  { title: "Thumbnail Maker", badge: "Free", color: "from-pink-900 to-rose-900", icon: Image, link: "/create" },
  { title: "Background Music", badge: "Creator", color: "from-indigo-900 to-blue-900", icon: Music, link: "/create" },
  { title: "Prompt Enhancer", badge: "Free", color: "from-cyan-900 to-blue-900", icon: Wand2, link: "/create" },
    ...
    <div className="min-h-screen bg-yt-bg pb-20">
      ...
      <main className="pt-16 px-4">
        <div className="flex gap-3 overflow-x-auto pb-4 mb-4 no-scrollbar">
          {["All", "Images", "Voice", "Scripts", "Tools"].map((cat, i) => (
            <button 
              key={cat} 
